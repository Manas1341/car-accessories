...
import Black_Seat_Cover from '../../images/Hyundai/creta/Base/black seat cover.jpg'
import Cup_Holder from '../../images/Hyundai/creta/Base/cup holder coaster.jpg'
import Reverse_Camera from '../../images/Hyundai/creta/Base/reverse camera.png'
...
const Creta_Base_Model = () => {
    const images = [
        { src: Black_Seat_Cover, alt: 'Black Seat Cover', description: 'Custom description for Rubber Floor Mat.' },
        { src: Cup_Holder, alt: 'Cup Holder', description: 'Custom description for Interior Roof Light.' },
        { src: Reverse_Camera, alt: 'Reverse Camera', description: 'Custom description for Wipers.' },
...
export default Creta_Base_Model
