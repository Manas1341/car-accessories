...
const YourComponent = ({ onSelectModelVariant }) => {
  ...
  const [categories, setCategories] = useState([
    ...
    { id: 'suvs', label: "SUV's", cars: [
      { name: 'Kia Sonet', variants: ['Sonet All Models'] },
      { name: 'Kia Seltos', variants: [ 'Seltos All Models'] },
    ] },
  ]);
  ...
  return (
    <div className="sidebar-content">
      <h3 style={{ textAlign: 'center' }}>Kia</h3>
  ...
  return (
    <>
      ...
      <div className="container">
          ...
          {selectedDetails && <CarDetails details={selectedDetails} companyFolder="KiaPages" />}
          </div>
      </div>
    </>
  );
